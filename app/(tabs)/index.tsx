            ...
            <View style={styles.heroContent}>
              ...
              <LinearGradient
                colors={[
                  ...
                  'rgba(168,50,72,0.01)',
                  'rgba(168,50,72,0.015)',
                  'rgba(168,50,72,0.02)',
                  'rgba(168,50,72,0.025)',
                  'rgba(168,50,72,0.03)',
                  'rgba(168,50,72,0.035)',
                  'rgba(168,50,72,0.04)',
                  'rgba(168,50,72,0.045)',
                  'rgba(168,50,72,0.05)',
                  'rgba(168,50,72,0.055)',
                  'rgba(168,50,72,0.06)',
                  'rgba(168,50,72,0.065)',
                  'rgba(168,50,72,0.07)',
                  'rgba(168,50,72,0.075)',
                  'rgba(168,50,72,0.08)',
                  'rgba(168,50,72,0.085)',
                  'rgba(168,50,72,0.09)',
                  'rgba(168,50,72,0.095)',
                  'rgba(168,50,72,0.1)',
                  'rgba(168,50,72,0.11)',
                  'rgba(168,50,72,0.12)',
                  'rgba(168,50,72,0.13)',
