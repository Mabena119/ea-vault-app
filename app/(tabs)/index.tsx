            ...
            <View style={styles.heroContent}>
              ...
              <LinearGradient
                colors={[
                  ...
                  'rgba(134,188,209,0.01)',
                  'rgba(134,188,209,0.015)',
                  'rgba(134,188,209,0.02)',
                  'rgba(134,188,209,0.025)',
                  'rgba(134,188,209,0.03)',
                  'rgba(134,188,209,0.035)',
                  'rgba(134,188,209,0.04)',
                  'rgba(134,188,209,0.045)',
                  'rgba(134,188,209,0.05)',
                  'rgba(134,188,209,0.055)',
                  'rgba(134,188,209,0.06)',
                  'rgba(134,188,209,0.065)',
                  'rgba(134,188,209,0.07)',
                  'rgba(134,188,209,0.075)',
                  'rgba(134,188,209,0.08)',
                  'rgba(134,188,209,0.085)',
                  'rgba(134,188,209,0.09)',
                  'rgba(134,188,209,0.095)',
                  'rgba(134,188,209,0.1)',
                  'rgba(134,188,209,0.11)',
                  'rgba(134,188,209,0.12)',
                  'rgba(134,188,209,0.13)',
                  'rgba(134,188,209,0.14)',
                  'rgba(134,188,209,0.15)',
                  'rgba(134,188,209,0.16)',
                  'rgba(134,188,209,0.17)',
                  'rgba(134,188,209,0.18)',
                  'rgba(134,188,209,0.19)',
                  'rgba(134,188,209,0.2)',
                  'rgba(134,188,209,0.22)',
                  'rgba(134,188,209,0.24)',
                  'rgba(134,188,209,0.26)',
                  'rgba(134,188,209,0.28)',
                  'rgba(134,188,209,0.3)',
                  'rgba(134,188,209,0.32)',
                  'rgba(134,188,209,0.34)',
                  'rgba(134,188,209,0.36)',
                  'rgba(134,188,209,0.38)',
                  'rgba(134,188,209,0.4)',
                  'rgba(134,188,209,0.42)',
                  'rgba(134,188,209,0.44)',
                  'rgba(134,188,209,0.46)',
                  'rgba(134,188,209,0.48)',
                  'rgba(134,188,209,0.5)',
                  'rgba(134,188,209,0.52)',
                  'rgba(134,188,209,0.54)',
                  'rgba(134,188,209,0.56)',
                  'rgba(134,188,209,0.58)',
                  'rgba(134,188,209,0.6)',
                  'rgba(134,188,209,0.62)',
                  'rgba(134,188,209,0.64)',
                  'rgba(134,188,209,0.66)',
                  'rgba(134,188,209,0.68)',
                  'rgba(134,188,209,0.7)',
                  'rgba(134,188,209,0.72)',
                  'rgba(134,188,209,0.74)',
                  'rgba(134,188,209,0.76)',
                  'rgba(134,188,209,0.78)',
                  'rgba(134,188,209,0.8)',
                  'rgba(134,188,209,0.82)',
                  'rgba(134,188,209,0.84)',
                  'rgba(134,188,209,0.86)',
                  'rgba(134,188,209,0.88)',
                  'rgba(134,188,209,0.9)',
                  'rgba(134,188,209,0.92)',
                  'rgba(134,188,209,0.94)',
                  'rgba(134,188,209,0.96)',
                  'rgba(134,188,209,0.98)',
                  'rgba(134,188,209,1)'
                ]}
...
const styles = StyleSheet.create({
  ...
  actionButton: {
    ...
    elevation: 8,
    minHeight: 88,
    // Ultra-transparent glass effect - 90% transparent
